...
export interface PluginGithubProjectsssProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::github-projectsss.project',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiBlogBlog extends Schema.SingleType {
  ...
  attributes: {
    ...
    excludedCourse: Attribute.Relation<
      'api::blog.blog',
      'oneToMany',
      'api::course.course'
    >;
...
export interface ApiCompanyInfoCompanyInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    companyAdress: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    ...
    menu: Attribute.Relation<
      ...
      'api::menu.menu'
    >;
    sociaLinks: Attribute.Component<'config.social-link', true>;
    showProfileLink: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::header.header',
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    postSelection: Attribute.Component<'blog.posts-selection'>;
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    menuItems: Attribute.Component<'layout.link', true>;
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.UID<'api::menu.menu', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Blocks;
    slug: Attribute.UID<'api::service.service', 'service'>;
    cover: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::github-projectsss.project': PluginGithubProjectsssProject;
